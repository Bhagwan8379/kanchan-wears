        ...
        >
            <div className="max-w-7xl mx-auto">
                ...
                >
                    ...
                    <a
                        onClick={() => navigate(-1)}
                        className="inline-flex items-center cursor-pointer text-pink-500 hover:text-pink-600 font-medium text-sm sm:text-base"
                    >
                        ...
                        >
                            ...
                            <div className="relative aspect-square">
                                ...
                                <button
                                    ...
                                    className="absolute left-2 cursor-pointer sm:left-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 p-1 sm:p-2 rounded-full shadow-md hover:bg-pink-50 hover:text-pink-500 transition-colors"
                                >
                                    <ChevronLeft className="w-4 h-4 sm:w-6 sm:h-6" />
                                </button>
                                <button
                                    onClick={() => handleImageNavigation("next")}
                                    className="absolute cursor-pointer right-2 sm:right-4 top-1/2 -translate-y-1/2 bg-white bg-opacity-80 p-1 sm:p-2 rounded-full shadow-md hover:bg-pink-50 hover:text-pink-500 transition-colors"
                                >
                    ...
                    >
                        <div className="bg-white rounded-xl shadow-md overflow-hidden p-4 sm:p-6">
                                ...
                                <div className="flex flex-wrap gap-2">
                                    {product.sizes.map(size => (
                                        <button
                                            ...
                                            className={`px-3 py-1 sm:px-4 sm:py-2 cursor-pointer text-sm sm:text-base border rounded-md transition-colors ${selectedSize === size ? 'bg-pink-500 text-white border-pink-500' : 'bg-white text-gray-700 border-gray-300 hover:border-pink-300'}`}
                                        >
                                            {size}
                                        </button>
                                    ))}
                            ...
                            <div className="mb-4 sm:mb-6">
                                ...
                                <div className="flex gap-2 sm:gap-3">
                                    {product.colors.map(color => (
                                        <button
                                            key={color.name}
                                            className={`w-8 h-8 sm:w-10 sm:h-10 cursor-pointer rounded-full ${color.code} border-2 border-transparent hover:border-pink-500`}
                                ...
                                <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
                                    <div className="flex items-center border border-gray-300 rounded-md w-max">
                                        <button
                                            ...
                                            className="px-2 sm:px-3 py-1 sm:py-2 text-gray-600 hover:bg-pink-50 cursor-pointer hover:text-pink-500"
                                        >
                                        ...
                                        <button
                                            onClick={() => handleQuantityChange(quantity + 1)}
                                            className="px-2 sm:px-3 py-1 sm:py-2 text-gray-600 cursor-pointer hover:bg-pink-50 hover:text-pink-500"
                                        >
                                    ...
                                    <motion.button
                                        ...
                                        whileTap={{ scale: 0.98 }}
                                        className="bg-gradient-to-r from-pink-500 to-pink-600 cursor-pointer text-white py-2 sm:py-3 px-4 sm:px-6 rounded-md font-medium shadow-lg hover:shadow-pink-200 transition-all flex items-center justify-center"
                                    >
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-2 sm:gap-0">
                                <button className="text-sm sm:text-base text-gray-600 cursor-pointer hover:text-pink-500 flex items-center">
